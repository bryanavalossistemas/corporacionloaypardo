<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input class="formulario__input" type="number" id="numero" name="numero" placeholder="Numero de la Cuenta" value="<?php echo $cuenta_proveedor->numero; ?>">
    </div>
        ...
        <div class="formulario__campo--row">
            <select class="formulario__select" id="tipo_cuenta" name="tipo_cuenta_id">
                ...
                <?php foreach ($tipos_cuenta as $tipo_cuenta) { ?>
                    <option <?php echo ($cuenta_proveedor->tipo_cuenta_id === $tipo_cuenta->id) ? 'selected' : '' ?> value="<?php echo $tipo_cuenta->id; ?>"><?php echo $tipo_cuenta->nombre; ?></option>
                <?php } ?>
            </select>
        ...
        <div class="formulario__campo--row">
            <select class="formulario__select" id="banco" name="banco_id">
                ...
                <?php foreach ($bancos as $banco) { ?>
                    <option <?php echo ($cuenta_proveedor->banco_id === $banco->id) ? 'selected' : '' ?> value="<?php echo $banco->id; ?>"><?php echo $banco->nombre; ?></option>
                <?php } ?>
            </select>
        ...
        <div class="formulario__campo--row">
            <select class="formulario__select" id="moneda" name="moneda_id">
                ...
                <?php foreach ($monedas as $moneda) { ?>
                    <option <?php echo ($cuenta_proveedor->moneda_id === $moneda->id) ? 'selected' : '' ?> value="<?php echo $moneda->id; ?>"><?php echo $moneda->nombre; ?></option>
                <?php } ?>
            </select>
