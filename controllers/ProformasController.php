...
class ProformasController
{
    public static function index(Router $router)
    {
        ...
        if (!$pagina_actual) {
            header('Location: /admin/proformas?page=1');
        }
        ...
        $proformas = Proforma::paginar($registros_por_pagina, $paginacion->offset());
        $router->render('admin/proformas/index', [
            'titulo' => 'Proformas',
    ...
    public static function crear_proforma_vacia()
    {
        ...
        header("Location: /admin/proformas/crear?proforma_id=$proforma_id");
    }
    ...
    public static function crear(Router $router)
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (empty($alertas)) {
                ...
                $producto->guardar();
                header("Location: /admin/proformas/crear?proforma_id=$proforma->id");
            }
        }
        $router->render('admin/proformas/crear', [
            'alertas' => $alertas,
    ...
    public static function editar(Router $router)
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            $proforma->sincronizar($_POST);
            $proforma->guardar();
            header("Location: /admin/proformas");
        }
        $router->render('admin/proformas/editar', [
            'alertas' => $alertas,
    ...
    public static function eliminar_producto()
    {
        ...
        $proforma->sincronizar($_POST);
        $proforma->guardar();
        header("Location: /admin/proformas/crear?proforma_id=$producto_proforma->proforma_id");
    }
