...
CREATE TABLE `proformas` (
  ...
  `nombre_solicitante` varchar(255) DEFAULT 'varios',
  ...
  PRIMARY KEY (`id`),
  KEY `FK_proformas_tiendas_idx` (`tienda_id`),
  CONSTRAINT `FK_proformas_tiendas` FOREIGN KEY (`tienda_id`) REFERENCES `tiendas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
