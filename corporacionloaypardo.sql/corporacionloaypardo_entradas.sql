...
CREATE TABLE `entradas` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_entradas_proveedores_idx` (`proveedor_id`),
  CONSTRAINT `FK_entradas_proveedores` FOREIGN KEY (`proveedor_id`) REFERENCES `proveedores` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
