...
CREATE TABLE `boletas` (
  ...
  `fecha` varchar(255) DEFAULT 'CURRENT_TIMESTAMP',
  ...
  PRIMARY KEY (`id`),
  KEY `FK_boletas_tiendas_idx` (`tienda_id`),
  KEY `FK_boletas_clientes_idx` (`cliente_id`),
  CONSTRAINT `FK_boletas_clientes` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_boletas_tiendas` FOREIGN KEY (`tienda_id`) REFERENCES `tiendas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
